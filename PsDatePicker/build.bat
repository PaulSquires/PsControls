@echo off
rem ========================================================================================
rem  PsDatePicker demo build script.
rem
rem  Usage:  build.bat          builds main.exe
rem          build.bat clean    deletes build output
rem
rem  Run the geometry / date-math self-test with:  set PSDATEPICKER_SELFTEST=1 && main.exe
rem  Dump computed geometry with:                  set PSDATEPICKER_TRACE=1 && main.exe
rem ========================================================================================
