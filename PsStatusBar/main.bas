...
#define APPNAME          wstr("Custom StatusBar")
#define APPCLASSNAME     wstr("custom_statusbar_class")
...
dim shared as HWND HWND_STATUSBAR
dim shared as HWND HWND_STATUSBAR2    ' second instance: proves the control is per-instance
